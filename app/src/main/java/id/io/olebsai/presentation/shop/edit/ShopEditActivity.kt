package id.io.olebsai.presentation.shop.edit
...
import id.io.olebsai.databinding.ActivityShopEditBinding
    ...
    private fun initView() {
        ...
        shop?.let { shop ->
            ...
            with(binding) {
                ...
                etBank.setText(shop.bank)
                etBankAccountName.setText(shop.noRekening)
                etBankAccountNumber.setText(shop.namaPemilikRekening)
            }
        }
    }
